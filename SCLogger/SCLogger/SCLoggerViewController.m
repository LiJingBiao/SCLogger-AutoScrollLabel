...
- (void)generatePhrase
{
    ...
    NSLog(@"self.logTextView.contentSize.height:%f\nself.logTextView.bounds.size.height:%f\nheight:%f\noffset:%f",self.logTextView.contentSize.height,self.logTextView.bounds.size.height,height,offset);
